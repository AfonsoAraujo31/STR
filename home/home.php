  ...
  <header>
    ...
    <ul class="nav_links">
      <li class="li"><a class="active" href="http://localhost/STR/home/home.php"><i class="fa-solid fa-house"></i>
          Início</a></li>
      <li class="li"><a href="http://localhost/STR/voluntariado/voluntariado.php"><i
      ...
      <li>
        ...
        <li class="user-container"><a href="teste.html"><span><img class="user" src="images/user.png" /></span></a></li>
      </li>
    </ul>
  </header>
