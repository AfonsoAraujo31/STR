    ...
    <div id="results">
        ...
        <div class="wrapper">
            <div class="faq">
                ...
                <div class="panel">
                    <p>A Casa do Brasil de Lisboa (CBL) é uma associação de imigrantes sem fins lucrativos, fundada em janeiro de 1992 por brasileiros/as residentes em Portugal e portugueses/os amigos/as do Brasil e está aberta a todas as nacionalidades.</p>
                </div>
            </div>
            ...
            <div class="faq">
                ...
                <div class="panel">
                    <p>Desde a sua fundação, a CBL tem um trabalho ativo na reflexão e implementação das políticas públicas, assumindo um papel fundamental de ativismo e reivindicação de políticas igualitárias para as comunidades imigrantes em Portugal. Desenvolvemos projetos com ações que pretendem promover o acesso aos direitos e aos serviços de forma igualitária para as pessoas imigrantes. Além do trabalho de intervenção social e de ativismo, promovemos a valorização da multiculturalidade, da intercultural idade e a integração por meio da cultura.</p>
                </div>
            </div>
            ...
            <div class="faq">
                ...
                <div class="panel">
                    <p><b>O que é?</b></p>
                    <ul>
                        <li><i class="fa-solid fa-square squareli"></i>É tomar posições políticas contra as manifestações de racismo, xenofobia, desigualdades de género, perseguição de governos, políticos e os seus partidos, entre outros;</li>
                        ...
                        <li><i class="fa-solid fa-square squareli"></i>É promover debates e sessões de esclarecimentos sobre direitos e deveres, diálogo constante com o governo e partidos políticos, para a elaboração e desenvolvimento de políticas públicas que promovam o acolhimento e apoio aos, as migrantes e refugiados/as;</li>
            ...
            <div class="faq">
                ...
                <div class="panel">
                    ...
                    <p>O Bar da Casa é o espaço cultural onde a associação desenvolve e acolhe atividades de várias áreas artísticas, como concertos musicais, teatro, exposições, gastronomia, ciclos de cinema, workshops, exposições, debates e palestras. É um espaço de encontro de culturas que visa apoiar artistas a mostrarem o seu trabalho a diferentes públicos, promovendo o conhecimento e interação num circuito alternativo.
                        Ligado aos e às imigrantes e aos assuntos do Brasil, a sua missão intervém ativamente não só pela divulgação da cultura brasileira, nomeadamente os novos artistas brasileiros/os pouco conhecidos em Portugal, mas também pela criação de um espaço de ação política, reflexão e debate de ideias. O seu principal objetivo é a integração pela cultura e conhecimento numa perspetiva participativa e transformadora.
