...
<body>
  <header>
    ...
    <ul class="nav_links" id="routesList">
      <li class="li"><a class="active" href="" onclick="carregarConteudo('pagina1');" id="homeLink"><i class="fa-solid fa-house"></i>Início</a></li>
      ...
      <li>
        ...
        <div class="language">
          <div class="language-selected"><img id="flags" src="../view/assets/flags/pt.png" width="35px" height="25px" style="margin-right:10px;">Português</div>
          <ul cl>
  ...
  <script src="../configurations/routes.ts"></script>
  <script>
    // Importar as rotas definidas no arquivo rotas.js
    import rotas from '../configurations/routes.ts';

    // Função para carregar o conteúdo da página
    const carregarConteudo = (rota) => {
