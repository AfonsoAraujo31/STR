...
<head>
  ...
  <title>STR</title>
  <!-- CSS -->
  <link rel="stylesheet" href="doacaoespecial.scss" />
...
<body>
  <header>
    ...
    <ul class="nav_links">
      <li class="li"><a href="http://localhost/STR/home/home.php"><i class="fa-solid fa-house"></i>
          Início</a></li>
  ...
  <!-- JavaSricpt -->
  <script type="module" src="doacaoespecial.js"></script>
