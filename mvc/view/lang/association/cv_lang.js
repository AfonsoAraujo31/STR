...
$(function () {
    $(".pt").click(function () {
      ...
      $(".panel").children().eq(2).html("<ul><li><i class='fa-solid fa-square squareli'></i>Compromisso, com os valores da instituição;</li><li><i class='fa-solid fa-square squareli'></i>Proactividade, ter espírito crítico, tomar a iniciativa, querer fazer mais e chegar mais longe;</li><li><i class='fa-solid fa-square squareli'></i>Envolvimento, acreditar nos objectivos e propósitos da organização, perspectivando sempre resultados positivos;</li><li><i class='fa-solid fa-square squareli'></i>Entrega, ter a capacidade de abraçar os diversos projectos, mostrando o melhor de ti.</li></ul>");
