...
<body>
  <header>
    ...
    <ul class="nav_links">
      <li class="li"><a class="active" href="../view/home.php"><i class="fa-solid fa-house"></i>
          Início</a></li>
      ...
      <li>
        ...
        if($_COOKIE["temp_user"] == ""){
          echo "<li class='user-container'><a href='http://localhost/STR/login/login.php'><span><img class='user' src='../view/assets/others/user.png' /></span></a></li></li>";
        }else{
