            ...
            <div class="input-group mb-3">
              <select class="custom-select form-rounded" id="inputGroupSelect01" style="width:280px;height:50px;">
                ...
                while ($row = mysqli_fetch_array($result)) {
                  ...
                  $nome = $row['nome'];
                  $iso = $row['iso'];
                  echo "<option value='$id'>$nome ($iso)</option>";
                }
                ?>
              </select>
            </div>
      ...
      <div class="panel left-panel">
        <div class="content" id="content_login">
          ...
          <script>
            function showbutton() {
              setTimeout(() => {
                document.getElementById("button").innerHTML = '<button class="btn btn-dark btn-lg btn-block btn_reg" type="button" style="margin:5px;width:115px;position:relative;left:415px;top:15px;">Criar</button>';
              }, 750);
            }
