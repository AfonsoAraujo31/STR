    ...
    <section class="home">
        <div id="home-box" class="box-visible">
            ...
            <div class="container_pref">
                ...
                <div class="content">
                    <form action="#">
                        <h4>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore in illo nam distinctio! Repellat rem beatae voluptatum ab. Et qui odit voluptatibus officiis impedit in voluptatum maxime excepturi aliquid cupiditate.</h4>
                    </form>
                </div>
            </div>
            <div class="content1">
