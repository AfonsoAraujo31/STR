                ...
                <div class="content">
                    <form action="update_user.php" method="GET">
                        ...
                        <div class="button">
                            ...
                            <script>
                                document.cookie = "current_user=" + localStorage.getItem('email');
                            </script>
                        </div>
                    </form>
                </div>
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            if ($row["email"] == $_GET["email"]) {
                                echo '
                <p>
                        <label>Linguagem pré definida ao iniciar sessão</label>
                        <select class="opc">
                            <option selected>'.$row["linguagem"].'</option>
                    ...
                    <p>
                        <label for="b">Em caso de contacto, forma preferida</label>
                        <select class="opc">
                        <option selected>'.$row["contacto"].'</option>
                            <option>Sem preferência</option>
                    ...
                    <p>
                        <label for="b">Preferência do estado dos cookies</label>
                        <select class="opc">
                        <option selected>'.$row["coockies"].'</option>
                            <option>Sem preferência</option>
                    ...
                    <p>
                        <label for="b">Memorizar dados ao iniciar sessão</label>
                        <select class="opc">
                        <option selected>'.$row["dados_login"].'</option>
                            <option>Sem preferência</option>
                            <option>Sim</option>
                            <option>Não</option>
                        </select>
