                    ...
                    <div class="column-xs-12 column-md-7">
                        <div class="product-gallery" id="product-gallery">
                            <div class="product-image">
                                <img class="active" src="images/cbl/cbl1.png">
                            </div>
                            <ul class="image-list" id="image-list">
                                <li class="image-item"><img src="images/cbl/cbl1.png"></li>
                                <li class="image-item"><img src="images/cbl/cbl2.png"></li>
                                <li class="image-item"><img src="images/cbl/cbl3.png"></li>
                            </ul>
                        </div>
                    </div>
...
A Casa do Brasil de Lisboa dispõe de um espaço de pesquisa de temas relacionados ao Brasil, às relações entre o Brasil e Portugal, à lusofonia em geral e às questões dos e das imigrantes em Portugal.</p>
    ...
    <script type="module" src="language/cbl.js"></script>
