                ...
                <div class="column-xs-12">
                    <nav>
                        <ol class="breadcrumb-list">
                            ...
                            <li class="breadcrumb-item active">Cruz Vermelha</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="wrapper">
        <div class="faq">
            <button class="accordion" aria-haspopup="true" aria-expanded="false">
                <span id="tab-title-dimensions_tab">What is Admiral Ackbar's favorite type of music?</span>
        ...
        <div class="faq">
            <button class="accordion" aria-haspopup="true" aria-expanded="false">
                <span id="tab-title-dimensions_tab">How does Darth Vader like his toast?</span>
                <div class="circle-animation closed">
                    <div class="horizontal"></div>
                    <div class="vertical"></div>
                </div>
            ...
            <div class="panel">
                <p>On the dark side.</p>
            </div>
        </div>

        <div class="faq">
            <button class="accordion" aria-haspopup="true" aria-expanded="false">
                <span id="tab-title-dimensions_tab">What is R2D2 short for?</span>
                <div class="circle-animation closed">
                    <div class="horizontal"></div>
                    <div class="vertical"></div>
                </div>
            ...
            <div class="panel">
                <p>Because he has little legs.</p>
            </div>
        </div>

        <div class="faq">
            <button class="accordion" aria-haspopup="true" aria-expanded="false">
                <span id="tab-title-dimensions_tab">Which program do Jedi use to open PDF files?</span>
                <div class="circle-animation closed">
                    <div class="horizontal"></div>
                    <div class="vertical"></div>
                </div>
