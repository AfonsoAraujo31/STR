...
$(function () {
    $(".pt").click(function () {
      ...
      $(".panel").eq(3).html("<p><b>Os Direitos Humanos</b></p>O direito a um tecto é inquestionável e é dos mais importantes para viver em dignidade. Pois não há dignidade sem tecto. Espírito de equipa acreditamos que unindo esforços e trabalhando em conjunto, facilitamos a nossa integração no país nos acolheu.");
    });
  });
  /**
   * ! LINGUAGEM DA PÁGINA
