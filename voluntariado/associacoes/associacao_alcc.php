...
<body>
                    ...
                    <div class="column-xs-12 column-md-7">
                        <div class="product-gallery" id="product-gallery">
                            <div class="product-image">
                                <img class="active" src="images/alcc/alcc1.png">
                            </div>
                            <ul class="image-list" id="image-list">
                                <li class="image-item"><img src="images/alcc/alcc1.png"></li>
                                <li class="image-item"><img src="images/alcc/alcc2.png"></li>
                                <li class="image-item"><img src="images/alcc/alcc3.png"></li>
                            </ul>
                        </div>
                    </div>
    ...
    <script type="module" src="language/alcc.js"></script>
