...
<body>
    <header>
        ...
        <ul class="nav_links">
            ...
            <li class="user-container"><a href="http://localhost/STR/login/login.php"><span><img class="user" src="images/user.png" /></span></a>
            </li>
            </li>
        </ul>
    </header>
                    ...
                    <div class="column-xs-12 column-md-7">
                        <div class="product-gallery" id="product-gallery">
                            <div class="product-image">
                                <img class="active" src="images/apirp/apirp2.png">
                            </div>
                            <ul class="image-list" id="image-list">
                                <li class="image-item"><img src="images/apirp/apirp2.png"></li>
                                <li class="image-item"><img src="images/apirp/apirp1.png"></li>
                                <li class="image-item"><img src="images/apirp/apirp3.png"></li>
                            </ul>
                        </div>
                    </div>
    ...
    <script type="module" src="language/apirp.js"></script>
