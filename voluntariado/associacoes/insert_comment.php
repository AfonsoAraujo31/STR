    ...
    if ($_GET['db'] == "cv") {
      ...
      if($login = 1){
        if ($_GET['db'] == "cv") {
          ...
          echo "<script>location.href='http://localhost/STR/voluntariado/associacoes/associacao_cpr.php?error=comment';</script>";
        } else if ($_GET['db'] == "apirp") {
          echo "<script>location.href='http://localhost/STR/voluntariado/associacoes/associacao_apirp.php?error=comment';</script>";
        } else if ($_GET['db'] == "alcc") {
          echo "<script>location.href='http://localhost/STR/voluntariado/associacoes/associacao_alcc.php?error=comment';</script>";
        } else if ($_GET['db'] == "cbl") {
          echo "<script>location.href='http://localhost/STR/voluntariado/associacoes/associacao_cbl.php?error=comment';</script>";
        }
      }
  }
} else {
