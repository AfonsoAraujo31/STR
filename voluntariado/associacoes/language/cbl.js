...
$(function () {
    $(".pt").click(function () {
      ...
      $(".panel").eq(0).html("A Casa do Brasil de Lisboa (CBL) é uma associação de imigrantes sem fins lucrativos, fundada em Janeiro de 1992 por brasileiros/as residentes em Portugal e portugueses/as amigos/as do Brasil e está aberta a todas as nacionalidades.");
  ...
  $(function () {
    $(".fr").click(function () {
      ...
      $(".breadcrumb-item").eq(0).html("<a href='http://localhost/STR/voluntariado/voluntariado.php'>Faire du bénévolat</a>");
      $(".breadcrumb-item").eq(1).text("Casa do Brasil de Lisboa");
      $(".h1").text("Casa do Brasil de Lisboa");
