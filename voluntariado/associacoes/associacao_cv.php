                        ...
                        <form action="insert_comment.php" method="GET">
                            <div class="card-footer py-3 border-0" style="background-color: transparent;">
                                <div class="d-flex flex-start w-100">
                                    <!--<img class=rounded-circle shadow-1-strong me-3' src='data:image/png;base64,' width='40' height='40' />-->
                                    <div class="form-outline w-100">
                                        ...
                                        <?php
                                        echo "<input name='current_url' id='idUnico' value='" . $_SERVER['PHP_SELF'] . "' hidden> ";
                                        ?>
                                    </div>
                                </div>
                        ...
                        <div class="comments-app" id="comments-app" ng-app="commentsApp" ng-controller="CommentsController as cmntCtrl">
                            <div class="comment" id="comment">
                                <table id="load_data_table" style="width:100%;">
                                    ...
                                    <tr id="remove_row">
                                        <td><button type="button" name="btn_more" data-vid="<?php echo $video_id; ?>" id="btn_more" class="btn btn-sm" style="background-color: #ff5e14a8; color:  #fff;">Mais comentários</button></td>
                                    </tr>
