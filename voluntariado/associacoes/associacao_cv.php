...
<body>
    ...
    <div id="results">
                    ...
                    <div class="column-xs-12 column-md-7">
                        <div class="product-gallery">
                            <div class="product-image">
                                <img class="active" src="images/cv/cv3.png">
                            </div>
                            <ul class="image-list" id="image-list">
                                <li class="image-item"><img src="images/cv/cv3.png"></li>
                                <li class="image-item"><img src="images/cv/cv1.png"></li>
                                <li class="image-item"><img src="images/cv/cv2.png"></li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="wrapper">
            ...
            <div class="d-flex justify-content-center login" id="login">
                <form class="col-6 login" action="db_login.php" method="GET">
                    ...
                    <div class="card-footer py-3 border-0" style="background-color: transparent;">
                        <div class="d-flex flex-start w-100">
                            <div class="form-outline w-100">
                                <div id="errorAlert" class="alert alert-warning hide-item" role="alert">É necessário  preencher o campo!</div>
                                ...
                                <script>document.getElementById("idUnico").value = localStorage.getItem("temp_user");const db="cv";</script>
                            </div>
                        </div>
                        <div class="float-end mt-2 pt-1">
                            <button type="button" class="btn btn-sm comentario" onclick="teste()" style="background-color: #ff5e14a8; color:  #fff; box-shadow: none;">Enviar comentário</button>
                            <button type="button" class="btn btn-outline btn-sm comentario" onclick="clear_text()" style="background-color: #ff5e14a8; color: #fff;box-shadow: none;">Cancelar</button>
                        </div>
                    </div>
                </form>
