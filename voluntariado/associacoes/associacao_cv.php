...
<body>
    ...
    <div id="results">
        ...
        <div class="wrapper">
            ...
            <div class="faq">
                <span class="accordion" id="tab-title-dimensions_tab">Comentários</span>
            </div>
            ...
            <div id="comments">
                <form action="insert_comment.php" method="GET" id="comment_form">
                    <div class="card-footer py-3 border-0" style="background-color: transparent;">
                        ...
                        <div class="float-end mt-2 pt-1">
                            <button type="button" class="btn btn-sm" onclick="teste()" style="background-color: #ff5e14a8; color:  #fff;box-shadow:none;">Enviar comentário</button>
                ...
                <div class="comments-app" id="comments-app" ng-app="commentsApp" ng-controller="CommentsController as cmntCtrl">
                    <div class="comment" id="comment">
                        ...
                        <script>document.cookie = "language=" + localStorage.getItem('language');</script>
                        <?php
