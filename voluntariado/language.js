function associacoes_pt() {
  ...
  xhr.open("get", "associacoes_pt.json", true);
      ...
      list.forEach((element) => {
        ...
        <div class="image-container">
            <div class="small-image">
                <img src="img/${element.photo}/1.jpg" alt="" class="featured-image-1">
                <img src="img/${element.photo}/2.jpg" alt="" class="featured-image-1">
                <img src="img/${element.photo}/3.jpg" alt="" class="featured-image-1">
            </div>
            <div class="big-image">
                <img src="img/${element.photo}/1.jpg" alt="" class="big-image-1">
            </div>
        </div>
        <div class="content">
            <h3>${element.name}</h3>
...
function associacoes_en() {
  ...
  limpar();
  var xhr = new XMLHttpRequest();
  xhr.open("get", "associacoes_en.json", true);
  xhr.onreadystatechange = function () {
    if (xhr.readyState === 4) {
      var list = JSON.parse(xhr.responseText);
      list.forEach((element) => {
...
function associacoes_fr() {
  ...
  limpar();
  var xhr = new XMLHttpRequest();
  xhr.open("get", "associacoes_fr.json", true);
  xhr.onreadystatechange = function () {
    if (xhr.readyState === 4) {
      var list = JSON.parse(xhr.responseText);
      list.forEach((element) => {
...
function criarCookies(){
  document.cookie = "language_value="+sessionStorage.getItem("language")+"; expires=Thu, 31 Dec 2030 23:59:59 UTC"; 
}
/**
 * ! LINGUAGEM DA PÁGINA
 * ? Português JQUERY
