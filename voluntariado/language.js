      ...
      list.forEach((element) => {
        ...
        <div class="image-container">
            <div class="${element.class}">
                <img src="images/associacoes/${element.photo}" alt="" class="big-image-1">
            </div>
        </div>
        <div class="content">
            <h3>${element.name}</h3>
            ...
            <p>
            ${element.detail}
            <br><button class="button-28" id="${element.id}"><a class="button-28-link" href="http://localhost/STR/voluntariado/associacoes/associacao.php">Ver mais</a></button>
        </div>
      </div>`;
